...
def main():
  ...
  <g class="fade-in">
    <!-- Total Contributions -->
    <text x="95" y="90" fill="#ffffff" font-family="system-ui, -apple-system, sans-serif" font-size="32" font-weight="bold" text-anchor="middle">{total_contribs}</text>
    <text x="95" y="122" fill="#8b949e" font-family="system-ui, -apple-system, sans-serif" font-size="12" text-anchor="middle">Total Contributions</text>
